...
"""
        ...
        with postgres_conn.cursor() as cursor:
            cursor.execute(query, (int(data['temp_id']),data['title'],data['is_draft'],data['is_archived'],data['question_type'],json.dumps(data['answer']),data['author_id'],data['educ_center_id']))
